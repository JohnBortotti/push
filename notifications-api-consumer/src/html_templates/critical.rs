...
<body style="background-color:#ffffff;">
    <div style="background-color:#ffffff;">
        ...
        <div style="background:#FFCDB0;background-color:#FFCDB0;margin:0px auto;border-radius:4px;max-width:600px;">
            <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="background:#FFCDB0;background-color:#ffb9b0;width:100%;border-radius:4px;">
                <tbody>
                    <tr>
                                        ...
                                        <tr>
                                            <td align="left"
                                                ...
                                                <div
                                                    ...
                                                    <p class="date"
                                                        style="margin: 0; margin-bottom: 5px; font-size: 16px;">CRITICAL
                                                    </p>
                                                    <h2
